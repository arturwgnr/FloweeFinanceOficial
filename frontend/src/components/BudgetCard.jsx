  ...
  return (
    <div className={`card border ${bgColor || 'border-gray-100'}`}>
      <div className="budget-card__header">
        ...
        <button onClick={() => onDelete(budget.id)} className="budget-card__delete">
      ...
      <div className="budget-card__progress-section">
        <div className="budget-card__progress-labels">
          <span>Spent: <strong className="text-gray-700">${spent.toFixed(2)}</strong></span>
          <span>Limit: <strong className="text-gray-700">${monthlyLimit.toFixed(2)}</strong></span>
        </div>
