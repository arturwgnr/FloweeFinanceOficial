...
const CATEGORIES = ['All', 'Food', 'Transport', 'Housing', 'Health', 'Entertainment', 'Shopping', 'Education', 'Other'];
  ...
  return (
    <div className="tx-row">
      <div className="tx-row__left">
        <div className={`tx-row__icon ${isIncome ? 'bg-green-100' : 'bg-red-100'}`}>
        ...
        <div className="tx-row__info">
          ...
          <p className="tx-row__meta">
            {transaction.category} · {date.toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' })}
          </p>
        </div>
      </div>
      <div className="tx-row__right">
        ...
        <button onClick={() => onEdit(transaction)} className="tx-row__edit-btn">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
              d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
          </svg>
        </button>
        <button onClick={() => onDelete(transaction.id)} className="tx-row__delete-btn">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
    ...
    <div className="space-y-6">
      <div className="transactions__header">
        <div>
          ...
          <p className="transactions__subtitle">{transactions.length} transactions found</p>
        </div>
      ...
      <div className="transactions__list-card">
        {loading ? (
          ...
          <div className="transactions__empty">
            ...
            <p className="transactions__empty-sub">Try changing the filters or add a new transaction</p>
          </div>
        ) : (
